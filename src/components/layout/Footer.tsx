  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black text-white pt-12 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center gap-3 justify-center md:justify-start">
              <div className="w-12 h-12 bg-gradient-to-r from-red-500 to-red-600 rounded-lg flex items-center justify-center shadow-lg mx-auto md:mx-0">
            ...
            <ul className="space-y-3">
              {t.quickLinks.links.map((link, index) => (
                ...
                >
                  <a
                    href={link.href}
                    className="text-gray-300 hover:text-red-500 transition-colors flex items-center justify-center md:justify-start gap-2 py-1 text-sm"
                  >
            ...
            <div className="space-y-4">
              {t.recentPosts.posts.map((post, index) => (
                <div key={index} className="group cursor-pointer">
                  ...
                  <p className="text-gray-300 text-sm group-hover:text-red-500 transition-colors leading-relaxed text-center md:text-left">
                    {post.content}
                  </p>
                </div>
              ))}
        ...
        {/* Bas de page - TOUJOURS centré sur mobile */}
