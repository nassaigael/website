            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-20">
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <div className="relative max-w-md mx-auto md:mx-0">
                            ...
                            <p className="text-sm leading-relaxed text-gray-600  md:text-base italic pl-0 md:pl-4">
                                "{t.organization.description}"
                            </p>
                        </div>

                        <div className="flex items-start gap-3 text-sm text-gray-600  bg-gray-100  p-4 rounded-xl border border-gray-200  hover:border-[#ee5253]/30 transition-all duration-300 max-w-md mx-auto md:mx-0">
                        ...
                        <div className="space-y-3 max-w-sm mx-auto md:mx-0">
                            {t.quickLinks.links.map((link, i) => (
                                <Link
                                    key={i}
                                    to={link.href}
                                    className="group flex items-center gap-3 p-3 bg-gray-100  rounded-lg border border-gray-200  hover:border-[#ee5253] hover:bg-gray-200  transition-all duration-300"
                                >
                                    ...
                                    <span className="text-sm text-gray-700  group-hover:text-[#ee5253] transition-colors flex-1 md:flex-none text-left">
                                        {link.label}
                                    </span>
                                </Link>
                            ))}
                    ...
                    >
                        <h3 className="text-lg font-bold text-gray-900  relative inline-block mx-auto md:mx-0">
                            {t.contact.title}
                            <span className="absolute -bottom-1.5 left-0 right-0 md:right-auto w-10 h-0.5 bg-[#ee5253] mx-auto md:mx-0" />
                        </h3>

                        {/* Email */}
                        <div className="group p-3 bg-gray-100  rounded-lg border border-gray-200  hover:border-[#ee5253] transition-all duration-300 max-w-sm mx-auto md:mx-0 w-full">
                            <div className="flex items-center gap-3 justify-start">
                                ...
                                <div className="text-left min-w-0 flex-1">
                                    ...
                                    <a
                                        ...
                                        className="text-xs font-medium text-gray-700  hover:text-[#ee5253] transition-colors block truncate"
                                    >
                                        {t.contact.email}
                                    </a>
                                </div>
                            ...
                            <div className="flex items-center gap-3 justify-start">
                                ...
                                <div className="text-left min-w-0 flex-1">
                                    ...
                                    <a
                                        ...
                                        className="text-xs font-medium text-gray-700  hover:text-[#ee5253] transition-colors block"
                                    >
                                        {t.contact.phone}
                                    </a>
                                </div>
                ...
                >
                            ...
                            {t.socialMedia.platforms.map((platform, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="relative w-12 h-12 bg-gray-200  group-hover:bg-[#ee5253] rounded-full flex items-center justify-center border border-gray-300  group-hover:border-transparent transition-all duration-300 shadow-lg">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-6 text-sm">
                        {/* Copyright */}
                        <p className="text-gray-500  text-center lg:text-left order-1">
                            {t.copyright.text}
                        </p>
                        ...
                        <div className="flex items-center gap-2 order-3">
                            ...
                            <a
                                ...
                                className="text-sm font-medium text-gray-800  hover:text-[#ee5253] transition-colors cursor-pointer"
                            >
                                Gaël RAMAHANDRISOA
                            </a>
                        </div>
                        ...
                        <div className="flex items-center gap-4 order-2">
                            {t.copyright.links && (
                                <>
                                    <a href="#" className="text-gray-500  hover:text-[#ee5253] transition-colors relative group">
