          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-12">
              ...
              <motion.button
                ...
                className={`px-6 py-3 rounded-full font-medium text-sm transition-all flex items-center gap-2 ${selectedCategory === 'all'
              ...
              {(['institutional', 'cultural', 'academic', 'media', 'community'] as PartnerCategory[]).map((category) => (
                <motion.button
                  ...
                  className={`px-6 py-3 rounded-full font-medium text-sm transition-all flex items-center gap-2 ${selectedCategory === category
                      ? 'bg-[#ee5253] text-white shadow-lg'
                      : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'
                    }`}
                >
