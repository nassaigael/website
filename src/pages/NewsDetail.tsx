            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() => navigate('/news')}
                        className="flex items-center gap-3 px-4 sm:px-5 py-2 sm:py-3 bg-white dark:bg-gray-900 rounded-xl shadow-lg hover:shadow-xl hover:bg-[#ee5253] border border-gray-200 dark:border-gray-800 transition-all group text-sm sm:text-base"
                    >
                        <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 dark:text-gray-400 group-hover:text-white transition-colors" />
                            ...
                            <AnimatePresence>
                                {showShareMenu && (
                                    <motion.div
                                        ...
                                        className="absolute top-full mt-2 right-0 w-48 bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden z-50"
                                    >
                                        {[
                ...
                >
                    <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
                        <span className={`px-3 py-1.5 sm:px-4 sm:py-2 rounded-full ${config.color} text-white font-bold text-xs sm:text-sm tracking-wider`}>
                    ...
                    <h1 className="text-2xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 dark:text-white mb-6 sm:mb-8 leading-tight">
                        {article.title[language]}
                    </h1>

                    <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed mb-6 sm:mb-8">
                ...
                <motion.div
                    ...
                    className="mb-12"
                >
                    <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden bg-gray-100 dark:bg-gray-800 shadow-xl sm:shadow-2xl">
                        <img
                        ...
                        {images.length > 1 && (
                            <>
                                <motion.button
                                    ...
                                    className="absolute left-3 sm:left-6 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-2 sm:p-3 rounded-full backdrop-blur-sm transition-all"
                                >
                                ...
                                <motion.button
                                    ...
                                    className="absolute right-3 sm:right-6 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-2 sm:p-3 rounded-full backdrop-blur-sm transition-all"
                                >
                ...
                <motion.div
                    ...
                    className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none mb-12 sm:mb-16"
                >
                    <div className="text-gray-700 dark:text-gray-300 space-y-4 sm:space-y-6 text-base sm:text-lg leading-relaxed">
                ...
                <motion.div
                    ...
                    className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 py-6 sm:py-8 border-t border-b border-gray-200 dark:border-gray-800 mb-12 sm:mb-16"
                >
                        ...
                        <div className="flex gap-1.5 sm:gap-2">
                            {[Facebook, Twitter, Linkedin].map((Icon, index) => (
                                <motion.button
                                    ...
                                    className="p-2 sm:p-2.5 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                                >
                    ...
                    >
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0 mb-8 sm:mb-10">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={() => navigate('/news')}
                                className="flex items-center justify-center gap-2 px-4 py-2.5 sm:px-5 sm:py-3 bg-[#ee5253] text-white font-semibold rounded-lg hover:shadow-lg transition-all w-full sm:w-auto text-sm sm:text-base"
                            >
                ...
                >
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() => navigate('/news')}
                        className="px-6 py-3 sm:px-8 sm:py-3.5 lg:px-10 lg:py-4 bg-[#ee5253] text-white font-bold rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all text-sm sm:text-base"
                    >
