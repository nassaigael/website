      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="relative">
                  ...
                  return (
                    ...
                    >
                      ...
                      {isActive && (
                        <motion.div
                          layoutId="active-tab"
                          className="absolute inset-0 bg-[#ee5253] shadow-lg"
            ...
            <div className="absolute -bottom-2 -right-2 w-4 h-4 border-b-2 border-r-2 border-[#ee5253]/30 rounded-br-lg" />
          </div>
        </motion.div>
            ...
            <div className="space-y-12">
              ...
              >
                ...
                <div className="relative bg-white dark:bg-[#0f172a] rounded-3xl shadow-2xl dark:shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-[#ee5253]/20 rounded-br-3xl" />
                </div>
              </motion.div>
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-linear-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                            ...
                            <span className="px-3 py-1 bg-[#ee5253] text-white text-xs font-medium rounded-full">
            ...
            <div className="space-y-12">
              ...
              >
                <div className="flex items-center gap-4 mb-10">
                  <div className="relative">
                    <div className="absolute inset-0 bg-[#ee5253] rounded-2xl blur-lg opacity-30" />
                    <div className="relative p-4 bg-[#ee5253] rounded-2xl shadow-xl">
                        ...
                        <div className="p-8">
                          <div className="absolute top-6 right-6">
                            <div className="relative">
                              ...
                              <div className="relative w-12 h-12 bg-[#ee5253] text-white rounded-full flex items-center justify-center font-bold text-lg shadow-lg">
                                {index + 1}
                              </div>
                            </div>
                          </div>
                  ...
                  >
                    ...
                    <div className="relative bg-white dark:bg-[#0f172a] rounded-2xl p-6 border border-gray-200 dark:border-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                      <div className="flex items-center gap-4 mb-4">
                        <div className="relative">
                          <div className="absolute inset-0 bg-[#ee5253] rounded-xl blur-md opacity-30" />
                          <div className="relative p-3 bg-[#ee5253] rounded-xl">
