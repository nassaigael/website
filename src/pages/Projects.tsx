...
const ProjectsPage = () => {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className={`min-h-screen bg-white  pb-16 md:pb-32 ${location.pathname === '/projects' ? 'pt-15!' : ''
        }`}
    >
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 relative z-10">
            ...
            >
              {[
                ...
                >
                  ...
                  <div className="relative bg-white/90 /90 backdrop-blur-sm rounded-xl md:rounded-2xl p-4 md:p-6 border border-gray-200/50   shadow-lg hover:shadow-xl transition-all duration-300">
        ...
        >
          <div className="bg-white/90 /90 backdrop-blur-xl rounded-2xl shadow-lg   p-6 border border-gray-200 ">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              <div className="flex-1 w-full">
                <div className="relative group">
                  ...
                  <div className={`relative flex items-center bg-white  rounded-xl border-2 transition-all duration-300 ${isSearchFocused
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-24 py-4 bg-transparent text-gray-900  placeholder-gray-400  outline-none text-sm md:text-base rounded-xl"
                    />
                    {searchTerm && (
              ...
              <div className="relative w-full lg:w-auto">
                <motion.button
                  ...
                  className="w-full lg:w-64 flex items-center justify-between gap-2 px-4 py-3 bg-gray-100  rounded-xl border border-gray-200  hover:border-[#ee5253] transition-all"
                >
                ...
                <AnimatePresence>
                  {showFilters && (
                    <motion.div
                      ...
                      className="absolute top-full mt-2 right-0 w-full lg:w-64 bg-white  rounded-xl shadow-xl   border border-gray-200  overflow-hidden z-40"
                    >
                      {categories.map((cat) => (
                        <button
                          key={cat.id}
              ...
              <div>
                {!searchTerm && selectedCategory === 'all' && (
                  <motion.h3
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900  mb-8 md:mb-12 text-center"
                  >
